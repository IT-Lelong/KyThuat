...
public class KT02_Ketchuyen_Dialog {
    ...
    String g_today;
    public KT02_Ketchuyen_Dialog(Context context) {
    ...
    private void addControls() {
        ...
        if (cur_getdata != null && cur_getdata.moveToFirst()) {
            ...
            for (int i = 0; i < cur_getdata.getCount(); i++) {
                String g_ten = cur_getdata.getString(cur_getdata.getColumnIndexOrThrow("fka02"));
        ...
        if (cur_getdata1 != null && cur_getdata1.moveToFirst()) {
            ...
            for (int i = 0; i < cur_getdata1.getCount(); i++) {
                String g_date = cur_getdata1.getString(cur_getdata1.getColumnIndexOrThrow("ngay"));
