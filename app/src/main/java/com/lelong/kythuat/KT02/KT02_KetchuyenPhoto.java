...
public class KT02_KetchuyenPhoto {
    ...
    public KT02_KetchuyenPhoto(Context context, Cursor c_getTc_far, KT02_Ketchuyen_Dialog ketChuyenDialog) {
    ...
    private void Call_transPhoto() {
        ...
        List<KT02_KetchuyenPhoto.FileInfo> filesToUpload = new ArrayList<>();
        for (int i = 0; i < c_getTc_far.getCount(); i++) {
            ...
            String image_somay = c_getTc_far.getString(c_getTc_far.getColumnIndexOrThrow("tc_far012"));
            ...
            KT02_KetchuyenPhoto.FileInfo fileInfo = new KT02_KetchuyenPhoto.FileInfo(image_no,image_date,image_dept,image_somay,image_name,image_note,file);
    ...
    public class FileInfo {
        ...
        private final String image_somay;
        ...
        public FileInfo(String image_no, String image_date, String image_dept, String image_somay, String image_name,String image_note, File file) {
            this.image_no = image_no;
            this.image_date = image_date;
            this.image_dept = image_dept;
            this.image_somay = image_somay;
    ...
    void uploadFileRecursive(final List<KT02_KetchuyenPhoto.FileInfo> files, final int currentIndex) {
        ...
        KT02_KetchuyenPhoto.FileInfo fileToUpload = files.get(currentIndex);
        ...
        callImage.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    if (status.equals("OK")) {
                        db.update_tc_farpost(fileToUpload.image_no,fileToUpload.image_date,fileToUpload.image_dept,fileToUpload.image_somay,fileToUpload.image_name);
