...
class KT01_DB {
    ...
    String CREATE_TABLE_FAA = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_TC_FAA + " ("
            ...
            + tc_faa003 + " TEXT ," + tc_faa004 + " TEXT," + tc_faa005 + " TEXT," + tc_faa006 + " TEXT,"
    ...
    public String append(String g_tc_faa001, String g_tc_faa002, String g_tc_faa003, String g_tc_faa004, String g_tc_faa005, String g_tc_faa006) {
        try {
            ...
            args.put(tc_faa004, g_tc_faa005);
            args.put(tc_faa004, g_tc_faa006);
    ...
    Cursor getAll_tc_faa(String app) {
        try {
            return db.rawQuery("SELECT tc_faa001,tc_faa002,tc_faa003,tc_faa004,tc_faa005,tc_faa006"
