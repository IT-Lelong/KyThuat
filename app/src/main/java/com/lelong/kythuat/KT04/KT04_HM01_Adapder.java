...
import com.lelong.kythuat.KT03.KT03_Camera;
import com.lelong.kythuat.R;

import java.util.List;

public class KT04_HM01_Adapder extends RecyclerView.Adapter<KT04_HM01_Adapder.DataViewHolder> {
    private final Context context;
    private final int resource;
    private final List<KT04_HM01_Model> objects;
    private final String g_date;
    private final String g_ca, g_id;
    KT04_DB kt04Db = null;

    public KT04_HM01_Adapder(@NonNull Context context, int resource, @NonNull List<KT04_HM01_Model> objects, String g_date, String g_ca, String g_id) {
    ...
    @Override
    public void onBindViewHolder(@NonNull KT04_HM01_Adapder.DataViewHolder holder, int position) {
        ...
        //holder.edt_ghiChu.setOnFocusChangeListener((v, hasFocus) -> {
            //if (!hasFocus) {
                ...
                //kt04Db.upd_HM0102("KT03_01_003", machitiet, nd, g_date, g_ca);
