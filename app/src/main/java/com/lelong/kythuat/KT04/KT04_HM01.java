...
public class KT04_HM01 extends Fragment {
    ...
    public KT04_HM01(Context context) {
        this.g_context = context;
    }

    public static KT04_HM01 newInstance(String qry_cond, Context context, String g_date, String g_ca, String g_id) {
        //KT03_HM01 fragment = new KT03_HM01(qry_cond, g_date,g_ca,g_id);
        KT04_HM01 fragment = new KT04_HM01(context);
        //g_context = context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //switch (g_dk) {
            //case "01":
                g_layout = R.layout.kt04_hm01_fragment;
                g_rcv_id = R.id.rcv4_hm01;
                //break;
            //case "02":
        ...
        Thread thread_CHK = new Thread(new Runnable() {
            @Override
            public void run() {
                cur_getAll[0] = kt04Db.getAll_HM0102(g_date, g_ca, g_dk);
            }
        });
        ...
        Thread thread_INS = new Thread(new Runnable() {
            @Override
            public void run() {
                ins_KT04_0102_file(g_date, g_ca, g_id);
            }
        });
            ...
            public void run() {
                ...
                for (int i = 0; i < num; i++) {
                    try {
                        ...
                        list_hm01.add(new KT04_HM01_Model(
                                tc_fac003, KT04_01_001, tc_fac006,
    ...
    private void ins_KT04_0102_file(String g_date, String g_ca, String g_id) {
