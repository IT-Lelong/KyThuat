...
public class KT04_HM01_Model implements Serializable {
    ...
    public void setG_bangiaoca(String g_ghichu) {this.g_ghichu = g_ghichu;}
    ...
    public KT04_HM01_Model(String g_stt, String g_maChiTiet, String g_noidungHM_TV,
