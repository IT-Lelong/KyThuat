...
public class KT04_HM03 extends Fragment {
    ...
    public KT04_HM03(Context context) {
        this.g_context = context;
    }

    public static KT04_HM03 newInstance(String qry_cond, Context context, String g_date, String g_ca, String g_id) {
        //KT03_HM01 fragment = new KT03_HM01(qry_cond, g_date,g_ca,g_id);
        KT04_HM03 fragment = new KT04_HM03(context);
        //g_context = context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //switch (g_dk) {
        //case "01":
        g_layout = R.layout.kt04_hm03_fragment;
        g_rcv_id = R.id.rcv4_hm03;
        //break;
        //case "02":
        ...
        list_hm03 = new ArrayList<KT04_HM03_Model>();
        adapter = new KT04_HM03_Adapder(getContext(), R.layout.kt04_hm03_fragment_row, list_hm03, g_date, g_ca);
        ...
        Thread thread_CHK = new Thread(new Runnable() {
            @Override
            public void run() {
                cur_getAll[0] = kt04Db.getAll_HM03(g_date, g_ca, g_dk);
            }
        });
        ...
        Thread thread_INS = new Thread(new Runnable() {
            @Override
            public void run() {
                ins_KT04_03_file(g_date, g_ca, g_id);
            }
        });
            ...
            public void run() {
                ...
                for (int i = 0; i < num; i++) {
                    try {
                        ...
                        @SuppressLint("Range") String KT04_03_001 = cur_getAll.getString(cur_getAll.getColumnIndex("KT04_03_001"));
                        @SuppressLint("Range") String tc_fac006 = cur_getAll.getString(cur_getAll.getColumnIndex(g_lang));
                        @SuppressLint("Range") String tc_fac011 = cur_getAll.getString(cur_getAll.getColumnIndex("tc_fac011"));
                        @SuppressLint("Range") String KT04_03_002 = cur_getAll.getString(cur_getAll.getColumnIndex("KT04_03_002"));
                        @SuppressLint("Range") String KT04_03_003 = cur_getAll.getString(cur_getAll.getColumnIndex("KT04_03_003"));
                        @SuppressLint("Range") String KT04_03_004 = cur_getAll.getString(cur_getAll.getColumnIndex("KT04_03_004"));
                        @SuppressLint("Range") String KT04_03_005 = cur_getAll.getString(cur_getAll.getColumnIndex("KT04_03_005"));

                        list_hm03.add(new KT04_HM03_Model(tc_fac003,KT04_03_001, tc_fac006,tc_fac011,
                                KT04_03_002, KT04_03_003, KT04_03_004, KT04_03_005));
    ...
    private void ins_KT04_03_file(String g_date, String g_ca, String g_id) {
        ...
        for (int i = 0; i < num; i++) {
            try {
                ...
                kt04Db.append3(tc_fac004, "", "","","", g_date, g_ca, g_id);
            } catch (Exception e) {
                String err = e.toString();
            }
