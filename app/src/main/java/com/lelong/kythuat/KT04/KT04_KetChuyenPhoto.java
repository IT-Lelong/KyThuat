...
public class KT04_KetChuyenPhoto {
    KT04_DataClient KT04_apiService;
    KT04_DB db;
    private final Context context;
    private final Cursor c_getTc_far;
    private KT04_KetChuyen_Dialog KT04_ketChuyenDialog;

    public KT04_KetChuyenPhoto(Context context, Cursor c_getTc_far, KT04_KetChuyen_Dialog KT04_ketChuyenDialog) {
        ...
        KT04_apiService = retrofit.create(KT04_DataClient.class);
    ...
    private void Call_transPhoto() {
        ...
        KT04_ketChuyenDialog.setProgressBar(c_getTc_far.getCount());
        // Sử dụng một danh sách các tệp tin cần tải lên
        List<KT04_KetChuyenPhoto.FileInfo> filesToUpload = new ArrayList<>();
        for (int i = 0; i < c_getTc_far.getCount(); i++) {
            ...
            KT04_KetChuyenPhoto.FileInfo fileInfo = new KT04_KetChuyenPhoto.FileInfo(image_no,image_date,image_dept,image_to,image_name,image_note,file);
    ...
    void uploadFileRecursive(final List<KT04_KetChuyenPhoto.FileInfo> files, final int currentIndex) {
        if (currentIndex >= files.size()) {
            KT04_ketChuyenDialog.setStatus("2");
        ...
        KT04_KetChuyenPhoto.FileInfo fileToUpload = files.get(currentIndex);
        ...
        Call<ResponseBody> callImage = KT04_apiService.uploadImage3(imagePart, null);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    if (status.equals("OK")) {
                        ...
                        KT04_ketChuyenDialog.updateProgressBar(currentIndex + 1);
