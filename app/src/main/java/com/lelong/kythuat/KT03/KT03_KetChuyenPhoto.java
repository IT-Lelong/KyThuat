...
public class KT03_KetChuyenPhoto {
    KT03_DataClient KT03_apiService;
    KT03_DB db;
    private final Context context;
    private final Cursor c_getTc_far;
    private KT03_KetChuyen_Dialog KT03_ketChuyenDialog;

    public KT03_KetChuyenPhoto(Context context, Cursor c_getTc_far, KT03_KetChuyen_Dialog KT03_ketChuyenDialog) {
        ...
        KT03_apiService = retrofit.create(KT03_DataClient.class);
    ...
    private void Call_transPhoto() {
        ...
        KT03_ketChuyenDialog.setProgressBar(c_getTc_far.getCount());
        // Sử dụng một danh sách các tệp tin cần tải lên
        List<KT03_KetChuyenPhoto.FileInfo> filesToUpload = new ArrayList<>();
    ...
    void uploadFileRecursive(final List<KT03_KetChuyenPhoto.FileInfo> files, final int currentIndex) {
        if (currentIndex >= files.size()) {
            KT03_ketChuyenDialog.setStatus("2");
        ...
        KT03_KetChuyenPhoto.FileInfo fileToUpload = files.get(currentIndex);
        ...
        Call<ResponseBody> callImage = KT03_apiService.uploadImage3(imagePart, null);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    if (status.equals("OK")) {
                        ...
                        KT03_ketChuyenDialog.updateProgressBar(currentIndex + 1);
