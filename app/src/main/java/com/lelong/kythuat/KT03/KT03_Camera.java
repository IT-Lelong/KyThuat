...
public class KT03_Camera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kt03_camera);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog = new Dialog(KT03_Camera.this);
                dialog.setContentView(R.layout.kt03_dialog_enlarged_image);
                ...
                btn1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (l_checkdk == "TRUE") {
                            AlertDialog.Builder builder = new AlertDialog.Builder(KT03_Camera.this);
                            ...
                            builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    //int num2 = cursor_3.getInt(cursor_3.getColumnIndexOrThrow("KT03_01_010"));
                                    ...
                                    if(result == true){
                                        ...
                                        if (deleted) {
                                            ...
                                            cursor.moveToFirst();
                                            int num23 = cursor.getInt(cursor.getColumnIndexOrThrow("KT03_01_010"));
                                            int loadhinh = num23 - 1;
                                        /*if (loadhinh == 0) {
                                            db.appendUPDAEhinhanh(ID, "", loadhinh, l_ngay, ID1, "KT03_01_008", "KT03_01_010");
                                        }*/
                                            db.appendUPDAEhinhanh(l_hm, "", loadhinh, l_ngay, ID, "KT03_01_008", "KT03_01_010",ID1);
                                            imageView.setImageDrawable(null);
                                            menuID.setText("...");
                                            edt_ghichu.setText(" ");
                                            Toast.makeText(KT03_Camera.this, "Anh đã được xóa", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Log.d("BBB", "Failed to delete file: " + fileToDelete.getAbsolutePath());
                                        }
                                    }
                                    else {
                                        Toast.makeText(KT03_Camera.this, "Anh đã được kết chuyển", Toast.LENGTH_SHORT).show();
                                    }
                                    ...
                                    if(result == true){
                                        ...
                                        if (deleted) {
                                            ...
                                            if (loadhinh == 0) {
                                                ...
                                                db.appendUPDAEhinhanh(l_hm, luutenanh,loadhinh, l_ngay,ID,"KT03_01_008","KT03_01_010",ID1);
                                            }

                                            imageView.setImageDrawable(null);
                                            menuID.setText("...");
                                            edt_ghichu.setText(" ");
                                            Toast.makeText(KT03_Camera.this, "Ảnh đã được xóa", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Log.d("BBB", "Failed to delete file: " + fileToDelete.getAbsolutePath());
                                        }
                                    }
...
//////////
        ...
        btnTakePicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(getApplicationContext(), KT03_OpenCamera.class);
                    ...
                    Toast.makeText(KT03_Camera.this, "Xóa ảnh cũ trước khi chụp ảnh mới!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    protected void onResume() {
        ...
        if (Constant_Class.UserFactory.equals("DH")) {
            ...
            cursor.moveToFirst();
            int num = cursor.getInt(cursor.getColumnIndexOrThrow("KT03_01_010"));
