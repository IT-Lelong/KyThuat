...
public class KT03_KetChuyen_Dialog {
    ...
    String g_today;
    public KT03_KetChuyen_Dialog(Context context) {
        this.context = context;
        dialog = new Dialog(context);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.kt03_ketchuyen_dialog);
    ...
    private void addControls() {
        ...
        if (cur_getdata != null && cur_getdata.moveToFirst()) {
            ...
            for (int i = 0; i < cur_getdata.getCount(); i++) {
                String g_ten = cur_getdata.getString(cur_getdata.getColumnIndexOrThrow("KT03_01_006"));
        ...
        if (cur_getdata1 != null && cur_getdata1.moveToFirst()) {
            ...
            for (int i = 0; i < cur_getdata1.getCount(); i++) {
                String g_date = cur_getdata1.getString(cur_getdata1.getColumnIndexOrThrow("KT03_01_004"));
        ...
        if (cur_getdata2 != null && cur_getdata2.moveToFirst()) {
            ...
            for (int i = 0; i < cur_getdata2.getCount(); i++) {
                String g_ca = cur_getdata2.getString(cur_getdata2.getColumnIndexOrThrow("KT03_01_005"));
                ca_List.add(g_ca);
